...
for dir in "$path_to_directories"/*; do
    ...
    if [ -d "$dir" ]; then
        ...
        echo python render.py -s $dir -m "baseline/ref_$name" --iteration 30000 --skip_test --extend_scale 4.
        python render.py -s $dir -m "baseline/ref_$name" --iteration 30000 --skip_test --extend_scale 4.
