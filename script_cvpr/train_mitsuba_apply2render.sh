    ...
    for lr in 1e-7 1e-8 1e-9 1e-10; do
        for dir in "$path_to_directories"/*; do
            ...
            if [ -d "$dir" ]; then
                ...
                #fi
                if [[ "$name" == *"rover"* ]]; then
                    echo python train_outside.py -s $dir -m "cvpr/mitsuba/${name}_init_$lr" --r_t_noise 0.0 0.0 1. --test_iterations 1 7000 20000 30000 --save_iterations 7000 20000 30000 --checkpoint_iterations 7000 20000 30000 --iterations 30000 --r_t_lr 0.002 0.002 --control_point_sample_scale 32 --extend_scale 10000 --opt_distortion --outside_rasterizer --flow_scale $flow_scale $flow_scale --iresnet_lr $lr --port 11423 --wandb_project_name mitsuba --wandb_mode online -w
                    python train_outside.py -s $dir -m "cvpr/mitsuba/${name}_init_$lr" --r_t_noise 0.0 0.0 1. --test_iterations 1 7000 20000 30000 --save_iterations 7000 20000 30000 --checkpoint_iterations 7000 20000 30000 --iterations 30000 --r_t_lr 0.002 0.002 --control_point_sample_scale 32 --extend_scale 10000 --opt_distortion --outside_rasterizer --flow_scale $flow_scale $flow_scale --iresnet_lr $lr --port 11423 --wandb_project_name mitsuba --wandb_mode online -w
                else
                    echo python train_outside.py -s $dir -m "cvpr/mitsuba/${name}_init_$lr" --r_t_noise 0.0 0.0 1. --test_iterations 1 7000 20000 30000 --save_iterations 7000 20000 30000 --checkpoint_iterations 7000 20000 30000 --iterations 30000 --r_t_lr 0.002 0.002 --control_point_sample_scale 32 --extend_scale 10000 --opt_distortion --outside_rasterizer --flow_scale $flow_scale $flow_scale --iresnet_lr $lr --port 11423 --wandb_project_name mitsuba --wandb_mode online
                    python train_outside.py -s $dir -m "cvpr/mitsuba/${name}_init_$lr" --r_t_noise 0.0 0.0 1. --test_iterations 1 7000 20000 30000 --save_iterations 7000 20000 30000 --checkpoint_iterations 7000 20000 30000 --iterations 30000 --r_t_lr 0.002 0.002 --control_point_sample_scale 32 --extend_scale 10000 --opt_distortion --outside_rasterizer --flow_scale $flow_scale $flow_scale --iresnet_lr $lr --port 11423 --wandb_project_name mitsuba --wandb_mode online
                fi
            fi
        done
