...
def loadCam(args, id, cam_info, resolution_scale, outside_rasterizer, flow_scale=1.):
...
def cameraList_from_camInfos(cam_infos, resolution_scale, args, outside_rasterizer, flow_scale=1.):
    camera_list = []

    for id, c in enumerate(cam_infos):
        camera_list.append(loadCam(args, id, c, resolution_scale, outside_rasterizer, flow_scale=flow_scale))
